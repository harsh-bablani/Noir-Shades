...
const newArrivals = [
  {
    ...
    oldPrice: 4000,
    discount: "-50%",
		image: "./public//images/Wonder 24.svg",
    isNew: true,
  },
  {
    id: 2,
  ...
  return (
    <section style={{ background: "#f7f9fc", padding: "3rem 0", marginTop: "2rem" }}>
      <div style={{ maxWidth: "1400px", margin: "0 auto", padding: "0 1rem" }}>
        <h2 style={{ fontSize: "2.5rem", fontWeight: "bold", marginBottom: "0.5rem" }}>Best Selling</h2>
        <p style={{ marginBottom: "2.5rem", color: "#666" }}>All best design for the new season</p>
        <div>
          <button
            style={{
              background: "#fff",
